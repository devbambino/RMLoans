"use client";
//src/components/PrestamoRapido.tsx
...
export default function PrestamoRapido() {
  ...
  const getRepayStepLabel = (s: number) => {
    switch (s) {
      case 11:
        return "Verifying MXNB...";
      case 12:
        return "Paying Debt...";
      case 13:
        return "Withdrawing Collateral...";
      case 14:
        return "Unwrapping WmUSDC...";
      case 15:
        return "Recovering USDC...";
      case 16:
        return "Completed!";
      default:
        return "Processing...";
  ...
  const isExceedingLiquidity =
    borrowAmount && parseFloat(borrowAmount) > parseFloat(marketLiquidity);
          ...
          {!authenticated ? (
            ...
            <>
              ...
              <div className="grid grid-cols-3 gap-2 mb-2 p-2 mt-16 bg-white/5 rounded-xl border border-white/10">
                ...
                <div className="text-center">
                  <div className="text-[10px] uppercase text-gray-500 font-bold mb-1 flex items-center justify-center gap-1">
                    <CreditCardIcon className="w-3 h-3 text-red-400" /> Current
                    Debt
                  </div>
                  <div className="font-mono text-xs text-red-300 truncate">
                    {borrowBalance} MXNB
                  </div>
                </div>
                <div className="text-center border-l border-white/5">
                  <div className="text-[10px] uppercase text-gray-500 font-bold mb-1 flex items-center justify-center gap-1">
                    <ChartBarIcon className="w-3 h-3 text-yellow-400" /> Rate
                    (APR)
                  </div>
                ...
                <div className="text-center border-l border-white/5">
                  <div className="text-[10px] uppercase text-gray-500 font-bold mb-1 flex items-center justify-center gap-1">
                    <CircleStackIcon className="w-3 h-3 text-blue-400" />{" "}
                    Liquidity
                  </div>
                  <div className="font-mono text-xs text-blue-300 truncate">
                    {marketLiquidity} MXNB
                  </div>
                </div>
              </div>
                ...
                <div className="py-8 text-center space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-500">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      You received{" "}
                      <span className="text-[#50e2c3] font-bold text-lg">
                        {borrowAmount} MXNB
                      </span>
                    </p>
                  </div>
                    ...
                    <div className="text-sm bg-white/5 p-4 rounded-lg space-y-2 text-left">
                      <div className="flex justify-between">
                        ...
                        <span className="text-white font-mono">
                          {totalRepaidAmount || "Calculating..."} MXNB
                        </span>
                      </div>
                      <div className="flex justify-between">
                        ...
                        <>
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-purple-300 font-mono">
                              {userInterestInMxnb} MXNB (~= {userInterestInUSDC}
                              )
                            </span>
                            <span className="text-xs text-purple-300 font-mono">
                              (Approx. {userInterestInUSDC} USDC)
                            </span>
                          </div>
                        </>
                      )}
                  ...
                  {step === 8 && !loading && (
                    <div className="p-4 rounded-xl bg-green-500/10 border border-green-500/20 text-green-200 text-sm text-center">
                      ...
                      <p className="opacity-80">
                        You received {borrowAmount} MXNB.
                      </p>
                    </div>
                  )}
